import {g as j, l as C} from "./index-zOfEP0jm.js";
var p = {
    exports: {}
}, a = typeof Reflect == "object" ? Reflect : null, h = a && typeof a.apply == "function" ? a.apply : function(e, n, r) {
...
o.prototype.emit = function(e) {
    ...
    if (typeof c == "function")
        ...
        for (var d = c.length, O = E(c, d), r = 0; r < d; ++r)
            h(O[r], this, n);
    return !0
}
;
...
function w(t, e, n) {
    ...
    if (r === void 0)
        return [];
    var i = r[e];
    return i === void 0 ? [] : typeof i == "function" ? n ? [i.listener || i] : [i] : n ? A(i) : E(i, i.length)
}
